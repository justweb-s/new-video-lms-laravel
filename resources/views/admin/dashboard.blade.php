            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="mt-4">
                            <a href="{{ route('admin.students.index') }}" class="text-sm text-primary hover:text-primary/80">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="mt-4">
                            <a href="{{ route('admin.courses.index') }}" class="text-sm text-primary hover:text-primary/80">
