...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex space-x-4">
            ...
            <a href="{{ route('admin.courses.sections.lessons.create', [$course, $section]) }}" class="bg-primary hover:bg-primary/90 text-white font-bold py-2 px-4 rounded">
                Nuova Lezione
            </a>
        </div>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($section->lessons->sortBy('lesson_order') as $lesson)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($lesson->video_url)
                                        <a href="{{ $lesson->video_url }}" target="_blank" class="text-primary hover:text-primary/90" title="Visualizza Video">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <a href="{{ route('admin.courses.sections.lessons.show', [$course, $section, $lesson]) }}" class="text-primary hover:text-primary/90" title="Visualizza">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                            </svg>
                                        </a>
                                        <a href="{{ route('admin.courses.sections.lessons.edit', [$course, $section, $lesson]) }}" class="text-primary hover:text-primary/90" title="Modifica">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @else
            <div class="text-center py-12">
                ...
                <div class="mt-6">
                    <a href="{{ route('admin.courses.sections.lessons.create', [$course, $section]) }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-primary hover:bg-primary/90">
