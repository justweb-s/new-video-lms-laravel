                ...
                <div class="bg-white shadow-md rounded-lg p-6 mb-6">
                    ...
                    @else
                        <div class="bg-gray-100 rounded-lg p-4 text-center">
                            ...
                            <a href="{{ $lesson->video_url }}" target="_blank" class="mt-2 inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200">
                                Apri Video
                            </a>
                        </div>
                    @endif
            ...
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="text-center">
                        <div class="text-2xl font-bold text-blue-600">{{ $lesson->progress_count }}</div>
