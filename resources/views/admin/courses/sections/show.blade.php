...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="bg-white shadow-md rounded-lg p-6 mb-8">
        ...
        @if($section->description)
            <div class="mt-6 pt-6 border-t border-gray-200">
                <h3 class="text-lg font-medium text-gray-900 mb-2">Descrizione</h3>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <a href="{{ route('admin.courses.sections.lessons.create', [$course, $section]) }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded text-sm">
                Nuova Lezione
            </a>
        </div>
        ...
        @else
            <div class="text-center py-12">
                ...
                <div class="mt-6">
                    <a href="{{ route('admin.courses.sections.lessons.create', [$course, $section]) }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700">
    ...
    <div class="mt-8 bg-white shadow-md rounded-lg p-6">
        <h3 class="text-lg font-medium text-gray-900 mb-4">Dettagli Sezione</h3>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
                <span class="text-gray-500">Data creazione:</span>
                <span class="ml-2 font-medium">{{ $section->created_at->format('d/m/Y H:i') }}</span>
            </div>
            <div>
                <span class="text-gray-500">Ultima modifica:</span>
                <span class="ml-2 font-medium">{{ $section->updated_at->format('d/m/Y H:i') }}</span>
            </div>
            <div>
            ...
            <div>
                ...
                <span class="ml-2 font-medium">{{ $section->lessons->sum('duration_minutes') }} minuti</span>
            </div>
        </div>
    </div>
</div>
