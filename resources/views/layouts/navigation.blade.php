<nav x-data="{ open: false }" class="bg-white/95 backdrop-blur border-b border-primary/10">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-primary/60 hover:text-primary hover:bg-primary/10 focus:outline-none focus:bg-primary/10 focus:text-primary transition duration-150 ease-in-out">
